...
<body>
    ...
    <div class="main">
        <form action="badd.jsp" method="post">
            <table>
                <tr>
                    <td>產品名稱:</td>
                ...
                <tr> <td>圖片2</td>
                    <td><input type="text" name="img2"></td></tr>
                <tr> <td>圖片3</td>
                    <td><input type="text" name="img3"></td></tr>
            </table>
            <input type="submit" value="新增" class="button"><input type="reset" class="button">
        </form>
